-- ============================================================================
-- Python Stored Procedure to Execute dbt Transformations - PROD Environment
-- ============================================================================
...
CREATE PROCEDURE IF NOT EXISTS ANALYTICS.STORED_PROCEDURE_DBT_TRANSFORMATIONS_PROD()
RETURNS VARCHAR
LANGUAGE PYTHON
RUNTIME_VERSION = '3.8'
...
def run_dbt():
    ...
    try:
        # Run dbt transformations for PROD environment
...
GRANT USAGE ON PROCEDURE ANALYTICS.STORED_PROCEDURE_DBT_TRANSFORMATIONS_PROD() TO ROLE APEXML_PROD_ADMIN;
GRANT USAGE ON PROCEDURE ANALYTICS.STORED_PROCEDURE_DBT_TRANSFORMATIONS_PROD() TO ROLE APEXML_PROD_WRITE;
