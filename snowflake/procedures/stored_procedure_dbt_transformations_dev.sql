-- ============================================================================
-- Python Stored Procedure to Execute dbt Transformations - DEV Environment
-- ============================================================================
...
CREATE PROCEDURE IF NOT EXISTS ANALYTICS.STORED_PROCEDURE_DBT_TRANSFORMATIONS_DEV()
RETURNS VARCHAR
LANGUAGE PYTHON
RUNTIME_VERSION = '3.8'
...
def run_dbt():
    ...
    try:
        # Run dbt transformations for DEV environment
...
GRANT USAGE ON PROCEDURE ANALYTICS.STORED_PROCEDURE_DBT_TRANSFORMATIONS_DEV() TO ROLE APEXML_DEV_ADMIN;
GRANT USAGE ON PROCEDURE ANALYTICS.STORED_PROCEDURE_DBT_TRANSFORMATIONS_DEV() TO ROLE APEXML_DEV_WRITE;
